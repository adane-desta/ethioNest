import"./modulepreload-polyfill-B5Qt9EMX.js";const c=document.getElementById("requests-nav"),p=document.getElementById("feedbacks-nav");document.getElementById("company-nav");const y=document.getElementById("properties-nav"),f=document.getElementById("users-nav"),m=document.getElementById("analytics-nav"),o=document.getElementById("contentArea");document.getElementById("modal");let n="";const s="http://localhost:5200/api";m.addEventListener("click",async()=>{u()});const u=async()=>{const r=await(await fetch(`${s}/platform_analytics`)).json();o.innerHTML=`

...
noResultsDiv.innerHTML = `
    ...
    <button class="btn-primary" onclick="window.location.href='../html-files/properties.html'">
        Browse Properties
    </button>
`;
        ...
        if (error.message.includes('login')) {
            propertyGrid.innerHTML = `
                <div class="no-results">
                    ...
                    <p>${error.message}</p>
                    <button class="btn-primary" onclick="window.location.href='../html-files/login.html'">
                        Login Now
                    </button>
                </div>
            `;
...
function showDetail(propertyId) {
    ...
    window.location.href = '../html-files/property-detail.html';
}